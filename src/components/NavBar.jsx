...
const NavBar = () => {
  return(
    <div>
      <Navbar id="newNav" collapseOnSelect expand="lg">
    <Navbar.Brand href="#/"><img className="img-fluid" src="/images/treeLogo.png" alt=""></img><h1 id="brandLogo">SHIPP BROTHERS LANDSCAPE</h1></Navbar.Brand>
    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
    <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="mr-auto">
    </Nav>
    <Nav>
      <Nav.Link id="newNav" href="#/">Home</Nav.Link>
